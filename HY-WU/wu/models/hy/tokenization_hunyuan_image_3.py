...
class HunyuanImage3TokenizerFast(PreTrainedTokenizerFast):
    ...
    def encode_sequence(
        ...
        for i, key in enumerate(keys):
            ...
            if key == "text":
                ...
                ), "cond_joint_image length should be a list of two integers"
    ...
    def encode_general(
        ...
        vae_image_slices, vae_image_mask = self.parse_extra_token_pos(extra_token_pos, "vae_img", full_seq_token_tensor)
        vit_image_slices, vit_image_mask = self.parse_extra_token_pos(extra_token_pos, "vit_img", full_seq_token_tensor)
    ...
    def __init__(
        ...
        if self.sequence_template == "pretrain":
            ...
            self.answer_ = [
                dict(
                    type="text",
                    text=self.tokenizer.answer_token,
        ...
        self.think_ = [
            dict(
                type="text",
                text=self.tokenizer.think_token,
        ...
        if hasattr(self.tokenizer, "recaption_token"):
            self.recaption_ = [
                dict(
                    type="text",
                    text=self.tokenizer.recaption_token,
