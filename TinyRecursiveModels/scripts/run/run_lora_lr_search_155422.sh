...
# ==========================================
# TRM LoRA LR Search Script (Checkpoint 155422)
# ==========================================
...
for lr in "${LRS[@]}"; do
    run_name="LoRA_lr${lr}_ckpt155422_$(date +%m%d_%H%M)"
    LOG_DIR="checkpoints/${run_name}"
    mkdir -p "${LOG_DIR}"

    echo "=========================================================="
    echo "Starting training for LR ${lr} (Checkpoint 155422, Rank ${FIXED_RANK})"
...
echo "所有 Learning Rate 测试完毕 (Checkpoint 155422)。"
