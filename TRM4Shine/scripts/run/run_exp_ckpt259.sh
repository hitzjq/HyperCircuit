...
# =========================================================
# 需要改：
# 1. 下面的BASE_CKPT，设置成step_259036的路径
...
BASE_CKPT="checkpoints/ARC-AGI-1/step_259036"
mkdir -p "logs"

# ---------------------------------------------------------
# Run 1: Unfreeze Embed Tokens = True
# ---------------------------------------------------------
RUN_NAME="LoRA_r64_ckpt259_unfreezeTrue_$(date +%m%d_%H%M)"
...
RUN_NAME="LoRA_r64_ckpt259_unfreezeFalse_$(date +%m%d_%H%M)"
LOG_FILE="logs/${RUN_NAME}.log"
LOG_DIR="checkpoints/${RUN_NAME}"
mkdir -p "${LOG_DIR}"
...
echo "🎉 All experiments in run_exp_ckpt259.sh completed."
