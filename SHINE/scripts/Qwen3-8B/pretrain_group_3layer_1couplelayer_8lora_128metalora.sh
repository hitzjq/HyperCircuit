...
NAME=8gpu_8lora_128metalora_lr5e-5_grouppretrain_3layer_1couplelayer_1150 # 4layer
NUM_GPUS=8
MASTER_PORT=18920       
...
python generate_group_idx.py  \
    ...
    metanetwork.transformer_cfg.layer_transformer_first=$LAYER_TRANSFORMER_FIRST \
