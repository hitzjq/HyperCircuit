...
# ============================================================
# 短线探索脚本 2/2: S5–S8 (LoRA参数和正则化探索)
# S5: lora_r=8
# S6: weight_decay=0.01
# S7: lora_alpha=16
# S8: lora_alpha=16 + lora_r=8
# ============================================================
...
BASE_CKPT_PATH="/mnt/kbei/HyperCircuit_Data/checkpoints/Arc1concept-aug-1000-ACT-torch/pretrain_att_arc1concept_4/step_155422"
CFG="cfg_wu4trm"
...
EXPERIMENTS=(
    "S5_lorar8|2|256|8|32|0.1"
    "S6_wd001|2|256|16|32|0.01"
    "S7_alpha16|2|256|16|16|0.1"
    "S8_alpha16_lorar8|2|256|8|16|0.1"
)
