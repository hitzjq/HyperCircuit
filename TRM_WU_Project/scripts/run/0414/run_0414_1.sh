...
# 格式: "标签|pg_num_blocks|pg_d_model|lora_r|lora_alpha|weight_decay|lr|puzzle_lr"
EXPERIMENTS=(
    "A1_baseline_fixed|2|256|16|32|0.1|1e-5|1e-3"
    "B1_pgb3|3|256|16|32|0.1|1e-5|1e-3"
)
