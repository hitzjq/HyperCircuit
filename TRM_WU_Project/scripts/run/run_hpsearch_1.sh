...
# ============================================================
# 超参搜索脚本 1/2
# 实验 A: lr=1e-5, puzzle_emb_lr=1e-3, warmup=2000
# 实验 B: lr=5e-6, puzzle_emb_lr=1e-3, warmup=2000
# ============================================================
...
EXPERIMENTS=(
    "lr1e5_plr1e3_wu2k|1e-5|1e-3|2000"
    "lr5e6_plr1e3_wu2k|5e-6|1e-3|2000"
)
