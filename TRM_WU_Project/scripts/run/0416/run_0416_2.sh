...
# ============================================================
# 短线脚本 2/4: R3 (rope_r4_full) + R4 (rope_r4_emb)
# ============================================================
...
EXPERIMENTS=(
    "R3_rope_r4_full|2|256|4|8|0.1|1e-5|1e-3|full_trm|True|True"
    "R4_rope_r4_emb|2|256|4|8|0.1|1e-5|1e-3|embedding_only|True|True"
)
