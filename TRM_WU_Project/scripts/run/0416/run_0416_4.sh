...
# ============================================================
# 短线脚本 4/4: R7 (rope_r8_nohead) + R8 (rope_r8_nohead_emb)
# ============================================================
...
EXPERIMENTS=(
    "R7_rope_r8_nohead|2|256|8|16|0.1|1e-5|1e-3|full_trm|True|False"
    "R8_rope_r8_nohead_emb|2|256|8|16|0.1|1e-5|1e-3|embedding_only|True|False"
)
