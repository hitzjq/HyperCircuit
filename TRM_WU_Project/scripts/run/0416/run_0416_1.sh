...
# ============================================================
# 短线脚本 1/4: R1 (rope_r8_full) + R2 (rope_r8_emb)
# ============================================================
...
EXPERIMENTS=(
    "R1_rope_r8_full|2|256|8|16|0.1|1e-5|1e-3|full_trm|True|True"
    "R2_rope_r8_emb|2|256|8|16|0.1|1e-5|1e-3|embedding_only|True|True"
)
